...
call managementreport.InsertUpdateBankStatement('ООО "СофтЭкспорт"', '4401038993', '40702810729000004845', '043469623',
  '330', '2023-02-09', '33002', '2023-02-09', 'Прочее списание','51', 'Заработная плата по реестру №514 от 09.02.2023 в соответствии с Договором 29011573 от 11.10.2016',
  '72981', 'КОСТРОМСКОЕ ОТДЕЛЕНИЕ N 8640 ПАО СБЕРБАНК (Расчетный)', '7707083893', '70', '-', '-');
