...
group by tsex.xDate
 ...
 having agt.xAgreement_Id is null 
  ...
  and tsex.xClientId != 13 -- пока отложим
  and tsex.xClientId = 197
--  and tsex.xProgramId like '358'
-- call brokenboeing.AddToAgreementTable ('2022-01-01', '2023-03-31', 16, 112, 197, '%', '%', '%', '-', '-', 'Алроса', '2022-06-01', '2023-12-31', 0, 'Меркурьев Михаил Викторович', '440103907157');
